    ...
    <div className='flex justify-center items-center h-screen'>
        <form className='bg-white p-6 rounded shadow-md w-full md:w-[500px]' onSubmit={submitHandler}>
            ...
            <div className='mb-4'>
                ...
                <input type="email" id='email' value={email} onChange={e=>setEmail(e.target.value)} className='border p-2 w-full rounded outline-none foucu:ring-2 focus:ring-blue-500' required/>
